...
// Forms are client side events so they can't be server rendered
// These events renders only client side
...
const VectroDBPage = () => {
  ...
  async function processStreamedProgress(response: Response) {
    ...
    if (!reader) {
      console.log("Reader was not found")
      return
    }
    try {
      while (true) {
